...
module platform_altera_merlin_axi_slave_ni_19112_7iufpaa
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_gdwykzq #(
        .SYMBOLS_PER_BEAT    (1),
    ...
    //altera_avalon_sc_fifo #(
    platform_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_ts3ol5y #(
        .SYMBOLS_PER_BEAT    (1),
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_62jpdbi #(
      .SYMBOLS_PER_BEAT (1),
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_4fg66bi #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_e5bhhdi #(
             .SYMBOLS_PER_BEAT (1),
