...
module platform_altera_merlin_axi_slave_ni_19112_i4rjryy
#(
    // -----------------------------------------------
   ...
   endgenerate 
    ...
    generate
        if (AXI_VERSION == "AXI4") begin
            ...
            assign arqos        = read_cp_data[PKT_QOS_H : PKT_QOS_L];
            assign arregion     = '0;
        end else begin
            assign arqos        = '0;
            assign arregion     = '0;
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_eeb7mqq #(
        .SYMBOLS_PER_BEAT    (1),
    ...
    //altera_avalon_sc_fifo #(
    platform_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_qb7i5yy #(
        .SYMBOLS_PER_BEAT    (1),
     ...
     //N2W milestone 1-3 achive shift register logic is implemented instead of response FIFO
      assign meta_write_data_resp_mem_in  =  write_cp_data[ST_DATA_W-1: PKT_ADDR_L];                               
...
generate 
   if (ENABLE_OOO == 1) begin
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_f7djlja #(
      .SYMBOLS_PER_BEAT (1),
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_qzgq26q #(
      .SYMBOLS_PER_BEAT (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_tauj2dy #(
             .SYMBOLS_PER_BEAT (1),
