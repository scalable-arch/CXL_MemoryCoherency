...
module platform_altera_merlin_axi_slave_ni_19112_ejrwosa
#(
    // -----------------------------------------------
...
// start of packet assertion should only happen at the start of burst and should not be asserted at the start of sub-burst
 ...
 generate 
   if (ENABLE_OOO == 0) begin
    ...
    platform_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_fxke7tq #(
        .SYMBOLS_PER_BEAT    (1),
    ...
    //altera_avalon_sc_fifo #(
    platform_altera_merlin_axi_slave_ni_altera_avalon_sc_fifo_19112_il5iyvy #(
        .SYMBOLS_PER_BEAT    (1),
...
generate
   ...
   if(ENABLE_OOO ==1 && REORDER_BUFFER == 0)begin
       ...
       platform_altera_merlin_axi_slave_ni_altera_avalon_st_pipeline_stage_19112_4dhp22q #(
             .SYMBOLS_PER_BEAT (1),
