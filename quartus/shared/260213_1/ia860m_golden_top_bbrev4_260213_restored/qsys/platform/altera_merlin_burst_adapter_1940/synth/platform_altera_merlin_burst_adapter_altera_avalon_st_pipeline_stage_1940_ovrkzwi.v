// platform_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_ovrkzwi.v

// Generated using ACDS version 25.1 129

`timescale 1 ps / 1 ps
module platform_altera_merlin_burst_adapter_altera_avalon_st_pipeline_stage_1940_ovrkzwi #(
		parameter SYMBOLS_PER_BEAT = 1,
		parameter BITS_PER_SYMBOL  = 259,
		...
		input  wire [258:0] in_data,           //          .data,          Input Data port of Avalon Streaming Sink Interface
		...
		output wire [258:0] out_data,          //          .data,          Output Data port of Avalon Streaming Source Interface
	...
	platform_altera_avalon_st_pipeline_stage_1930_oiupeiq #(
		...
		.in_data           (in_data),           //   input,  width = 259,          .data
		...
		.out_data          (out_data),          //  output,  width = 259,          .data
