...
module platform_altera_merlin_master_agent_1931_7uh3r5q
#(
   // -------------------
   ...
   function reg [BITS_TO_ZERO-1:0] unaligned_address_lsb;
       ...
       begin
           casez (byte_en)
               ...
               16'b??????????????10      :   unaligned_address_lsb = 4'b0001;

               16'b?????????????100      :   unaligned_address_lsb = 4'b0010;

               16'b????????????1000      :   unaligned_address_lsb = 4'b0011;

               16'b???????????10000      :   unaligned_address_lsb = 4'b0100;

               16'b??????????100000      :   unaligned_address_lsb = 4'b0101;

               16'b?????????1000000      :   unaligned_address_lsb = 4'b0110;

               16'b????????10000000      :   unaligned_address_lsb = 4'b0111;

               16'b???????100000000      :   unaligned_address_lsb = 4'b1000;

               16'b??????1000000000      :   unaligned_address_lsb = 4'b1001;

               16'b?????10000000000      :   unaligned_address_lsb = 4'b1010;

               16'b????100000000000      :   unaligned_address_lsb = 4'b1011;

               16'b???1000000000000      :   unaligned_address_lsb = 4'b1100;

               16'b??10000000000000      :   unaligned_address_lsb = 4'b1101;

               16'b?100000000000000      :   unaligned_address_lsb = 4'b1110;

               16'b1000000000000000      :   unaligned_address_lsb = 4'b1111;
               default :   unaligned_address_lsb = 4'b0000;
           endcase
       end
   endfunction 
