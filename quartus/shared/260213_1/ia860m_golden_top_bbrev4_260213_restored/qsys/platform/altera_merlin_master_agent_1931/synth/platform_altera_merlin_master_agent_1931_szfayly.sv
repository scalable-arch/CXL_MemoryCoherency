...
module platform_altera_merlin_master_agent_1931_szfayly
#(
   // -------------------
   ...
   function reg [BITS_TO_ZERO-1:0] unaligned_address_lsb;
       ...
       begin
           casez (byte_en)
               ...
               32'b??????????????????????????????10      :   unaligned_address_lsb = 5'b00001;

               32'b?????????????????????????????100      :   unaligned_address_lsb = 5'b00010;

               32'b????????????????????????????1000      :   unaligned_address_lsb = 5'b00011;

               32'b???????????????????????????10000      :   unaligned_address_lsb = 5'b00100;

               32'b??????????????????????????100000      :   unaligned_address_lsb = 5'b00101;

               32'b?????????????????????????1000000      :   unaligned_address_lsb = 5'b00110;

               32'b????????????????????????10000000      :   unaligned_address_lsb = 5'b00111;

               32'b???????????????????????100000000      :   unaligned_address_lsb = 5'b01000;

               32'b??????????????????????1000000000      :   unaligned_address_lsb = 5'b01001;

               32'b?????????????????????10000000000      :   unaligned_address_lsb = 5'b01010;

               32'b????????????????????100000000000      :   unaligned_address_lsb = 5'b01011;

               32'b???????????????????1000000000000      :   unaligned_address_lsb = 5'b01100;

               32'b??????????????????10000000000000      :   unaligned_address_lsb = 5'b01101;

               32'b?????????????????100000000000000      :   unaligned_address_lsb = 5'b01110;

               32'b????????????????1000000000000000      :   unaligned_address_lsb = 5'b01111;

               32'b???????????????10000000000000000      :   unaligned_address_lsb = 5'b10000;

               32'b??????????????100000000000000000      :   unaligned_address_lsb = 5'b10001;

               32'b?????????????1000000000000000000      :   unaligned_address_lsb = 5'b10010;

               32'b????????????10000000000000000000      :   unaligned_address_lsb = 5'b10011;

               32'b???????????100000000000000000000      :   unaligned_address_lsb = 5'b10100;

               32'b??????????1000000000000000000000      :   unaligned_address_lsb = 5'b10101;

               32'b?????????10000000000000000000000      :   unaligned_address_lsb = 5'b10110;

               32'b????????100000000000000000000000      :   unaligned_address_lsb = 5'b10111;

               32'b???????1000000000000000000000000      :   unaligned_address_lsb = 5'b11000;

               32'b??????10000000000000000000000000      :   unaligned_address_lsb = 5'b11001;

               32'b?????100000000000000000000000000      :   unaligned_address_lsb = 5'b11010;

               32'b????1000000000000000000000000000      :   unaligned_address_lsb = 5'b11011;

               32'b???10000000000000000000000000000      :   unaligned_address_lsb = 5'b11100;

               32'b??100000000000000000000000000000      :   unaligned_address_lsb = 5'b11101;

               32'b?1000000000000000000000000000000      :   unaligned_address_lsb = 5'b11110;

               32'b10000000000000000000000000000000      :   unaligned_address_lsb = 5'b11111;
               default :   unaligned_address_lsb = 5'b00000;
           endcase
       end
   endfunction 
