	component ccv_hps_to_noc is
		generic (
			DATA_WIDTH          : integer := 128;
			SYMBOL_WIDTH        : integer := 8;
			HDL_ADDR_WIDTH      : integer := 44;
			BURSTCOUNT_WIDTH    : integer := 5;
			COMMAND_FIFO_DEPTH  : integer := 32;
			RESPONSE_FIFO_DEPTH : integer := 32;
			MASTER_SYNC_DEPTH   : integer := 4;
			SLAVE_SYNC_DEPTH    : integer := 4;
		...
		port (
			...
			s0_writeresponsevalid : out std_logic_vector(0 downto 0);                                     -- writeresponsevalid
			...
			m0_writeresponsevalid : in  std_logic_vector(0 downto 0)                  := (others => 'X')  -- writeresponsevalid
		);
	end component ccv_hps_to_noc;

	u0 : component ccv_hps_to_noc
		generic map (
