...
module ccv_hps_to_noc #(
	...
	ccv_hps_to_noc_mm_ccb_1930_mksh4ka #(
		...
		.s0_byteenable         (s0_byteenable),         //   input,                width = 16,         .byteenable
		.s0_debugaccess        (s0_debugaccess),        //   input,                 width = 1,         .debugaccess
		.s0_response           (s0_response),           //  output,                 width = 2,         .response
		.s0_writeresponsevalid (s0_writeresponsevalid), //  output,                 width = 1,         .writeresponsevalid
		...
		.m0_byteenable         (m0_byteenable),         //  output,                width = 16,         .byteenable
		.m0_debugaccess        (m0_debugaccess),        //  output,                 width = 1,         .debugaccess
		.m0_response           (m0_response),           //   input,                 width = 2,         .response
		.m0_writeresponsevalid (m0_writeresponsevalid)  //   input,                 width = 1,         .writeresponsevalid
	);
