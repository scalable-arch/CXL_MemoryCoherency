module ccv_hps_to_noc #(
		parameter DATA_WIDTH          = 128,
		parameter SYMBOL_WIDTH        = 8,
		parameter HDL_ADDR_WIDTH      = 44,
		parameter BURSTCOUNT_WIDTH    = 5,
		parameter COMMAND_FIFO_DEPTH  = 32,
		parameter RESPONSE_FIFO_DEPTH = 32,
		parameter MASTER_SYNC_DEPTH   = 4,
		parameter SLAVE_SYNC_DEPTH    = 4,
		...
		input  wire [15:0]                 s0_byteenable,         //         .byteenable,         Indicates valid read/write data location
		...
		output wire [15:0]                 m0_byteenable,         //         .byteenable,         Indicates valid read/write data location
