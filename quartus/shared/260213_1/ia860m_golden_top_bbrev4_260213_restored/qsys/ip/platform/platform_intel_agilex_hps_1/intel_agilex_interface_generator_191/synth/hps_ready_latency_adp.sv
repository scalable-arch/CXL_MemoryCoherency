...
// aw channel
 ...
 // awvalid,awlen(8),awsize(3),awburst(2),awlock,awqos(4)
 localparam FIXED_WIDTH_AW =19;
 ...
 // arvalid,arlen(8),arsize(3),arburst(2),arlock,arqos(4)
 localparam FIXED_WIDTH_AR =19;
 ...
 // 2: wlast,wvalid
 localparam DATA_WIDTH_W = DATA_WIDTH + STRB_WIDTH + 2;
 ...
 localparam FLOP_DEPTH = NUM_PIPELINES/2; // half flops on cmd, rest on rsp path
  ...
  logic indata_awready, outdata_awready;
  logic [DATA_WIDTH_AW-1:0] indata_aw, outdata_aw;
  logic indata_arready, outdata_arready;
  ...
  logic indata_wready, outdata_wready;
 ...
 // aw channel 
  ...
  assign indata_aw = {awvalid,awid,awaddr,awlen,awsize,awburst,awlock,awuser,awqos,awbar,awcache,awdomain,awprot,awsnoop};
  ...
  assign {awvalid_r,awid_r,awaddr_r,awlen_r,awsize_r,awburst_r,awlock_r,awuser_r,awqos_r,awbar_r,awcache_r,awdomain_r,awprot_r,awsnoop_r} = outdata_aw;


 // awready only

  assign indata_awready = awready;
  ...
  .clk (clk),
  .in_data (indata_awready),
  .out_data (outdata_awready)

  );

  assign awready_r = outdata_awready;
 

 // ar channel 

 assign indata_ar = {arvalid,arid,araddr,arlen,arsize,arburst,arlock,aruser,arqos,arbar,arcache,ardomain,arprot,arsnoop};
  ...
  assign {arvalid_r,arid_r,araddr_r,arlen_r,arsize_r,arburst_r,arlock_r,aruser_r,arqos_r,arbar_r,arcache_r,ardomain_r,arprot_r,arsnoop_r} = outdata_ar;
 
 
 // arready only

 assign indata_arready = arready;
  ...
  .clk (clk),
  .in_data (indata_arready),
  .out_data (outdata_arready)

  );

  assign {arready_r} = outdata_arready;
 
 
 // w channel 

 assign indata_w = {wvalid,wdata,wlast,wstrb};
  ...
  assign {wvalid_r,wdata_r,wlast_r,wstrb_r} = outdata_w;
 
 // wready channel 
 assign indata_wready = wready;
  ff_macro_p2c # (
  .NUM_FLOPS (FLOP_DEPTH),
  .DATA_WIDTH (1)
  ) wready_inst (
  .clk (clk),
  .in_data (indata_wready),
  .out_data (outdata_wready)
  );
  assign wready_r = outdata_wready;
...
// input logic [3:0] arsnoop,
 ...
 // aw channel 
  ...
  assign indata_aw = {awvalid,awid,awaddr,awlen,awsize,awburst,awlock,awuser,awqos,awcache,awprot};
  ...
  assign {awvalid_r,awid_r,awaddr_r,awlen_r,awsize_r,awburst_r,awlock_r,awuser_r,awqos_r,awcache_r,awprot_r} = outdata_aw;
 ...
 assign indata_ar = {arvalid,arid,araddr,arlen,arsize,arburst,arlock,aruser,arqos,arcache,arprot};
  ...
  assign {arvalid_r,arid_r,araddr_r,arlen_r,arsize_r,arburst_r,arlock_r,aruser_r,arqos_r,arcache_r,arprot_r} = outdata_ar;
...
`pragma questa_oem_00 ""
`endif