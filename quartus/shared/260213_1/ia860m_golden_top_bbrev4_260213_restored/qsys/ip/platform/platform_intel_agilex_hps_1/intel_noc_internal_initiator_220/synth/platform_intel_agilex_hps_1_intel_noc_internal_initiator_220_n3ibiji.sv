...
module platform_intel_agilex_hps_1_intel_noc_internal_initiator_220_n3ibiji # (
  ...
  // Wires for unoc and shim connections
    ...
    logic [8:0]  shim_ch7_unoc_wr_addr_to_unoc_backbone;
        ...
        (* altera_attribute = {"-name FORCE_HYPER_REGISTER_FOR_PERIPHERY_CORE_TRANSFER ON; -name FORCE_HYPER_REGISTER_FOR_CORE_PERIPHERY_TRANSFER ON; -name NOC_INITIATOR ON; -name NOC_ISOLATION_GROUP HPS_NOC_ISOLATION_GROUP"} *) tennm_noc_initiator # (
            ...
            .NOC_INIU_THROTTLE_MODE_WR (NOC_INIU_THROTTLE_MODE_WR),
            .NOC_INIU_THROTTLE_MODE_RD (NOC_INIU_THROTTLE_MODE_RD),
            .NOC_INIU_UNOC_ONLY_AXI_READ(NOC_INIU_UNOC_ONLY_AXI_READ),
            
                //security parameters
          
            .NOC_INIU_PRIV_WRITE(MAJOR_WRITE_PRV),
            .NOC_INIU_PRIV_READ(MAJOR_READ_PRV),
