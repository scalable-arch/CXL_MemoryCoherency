...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_fp8_noc.sv"                    -work tennm_fp8_noc_ver        
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_fp8_noc_ncrypt.sv"             -work tennm_fp8_noc_ver        
  ...
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_iopll.sv"            -work tennm_revb_io96_iopll_ver
  vlogan +v2k -sverilog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                                  "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_iopll_ncrypt.sv"     -work tennm_revb_io96_iopll_ver
fi
