...
TOP_LEVEL_NAME="platform_intel_rtile_pcie_ast_0.platform_intel_rtile_pcie_ast_0"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/tools/intel/quartus/"
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [platform_intel_rtile_pcie_ast_0::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [platform_intel_rtile_pcie_ast_0::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set libraries [dict merge $libraries [platform_intel_rtile_pcie_ast_0::get_design_libraries]]
...
device_libraries='lpm_ver sgate_ver altera_ver altera_mf_ver altera_lnsim_ver tennm_ver tennm_hssi_ver tennm_fm_hps_ver tennm_fp8_noc_ver tennm_hssi_f1_ver tennm_hssi_r1_ver tennm_revb_io96_ver tennm_revb_io96_iopll_ver '
...
if [ $SKIP_DEV_COM -eq 0 ]; then
  ...
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_fp8_noc.sv"                -work tennm_fp8_noc_ver        
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_fp8_noc_ncrypt.sv"         -work tennm_fp8_noc_ver        
  ...
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_iopll.sv"        -work tennm_revb_io96_iopll_ver
  xmvlog -zlib 1 -sv -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS                        "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_iopll_ncrypt.sv" -work tennm_revb_io96_iopll_ver
fi
...
source $QSYS_SIMDIR/common/xcelium_files.tcl
set design_files [dict merge $design_files [platform_intel_rtile_pcie_ast_0::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/xcelium_files.tcl
set files [concat $files [platform_intel_rtile_pcie_ast_0::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
