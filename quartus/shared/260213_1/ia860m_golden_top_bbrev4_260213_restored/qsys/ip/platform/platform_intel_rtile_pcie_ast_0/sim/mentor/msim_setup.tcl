...
alias dev_com {
  ...
  if [ check_precomp_device $PRECOMP_DEVICE_LIB_FILE $FORCE_MODELSIM_AE_SELECTION ] {
    eval  qrun -compile -noautoorder -parallel -outdir ./libraries -vlog.options $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS -end \
     ...
     -makelib tennm_fp8_noc_ver "$DEVICES_SIM_LIB_DIR/tennm_fp8_noc.sv" -end \
     -makelib tennm_fp8_noc_ver "$DEVICES_SIM_LIB_DIR/tennm_fp8_noc_ncrypt.sv" -end \
     ...
     -makelib tennm_revb_io96_iopll_ver "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_iopll.sv" -end \
     -makelib tennm_revb_io96_iopll_ver "$DEVICES_SIM_LIB_DIR/tennm_revb_io96_iopll_ncrypt.sv" -end \
...
alias com {
  ...
  set common_design_files [dict values [platform_intel_rtile_pcie_ast_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [platform_intel_rtile_pcie_ast_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
