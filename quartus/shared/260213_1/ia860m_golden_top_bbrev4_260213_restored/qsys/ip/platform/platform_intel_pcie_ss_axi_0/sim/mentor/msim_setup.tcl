...
alias com {
  ...
  set common_design_files [dict values [platform_intel_pcie_ss_axi_0::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [platform_intel_pcie_ss_axi_0::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
