...
module platform_intel_noc_initiator_0_intel_noc_internal_initiator_220_6jjrcii # (
  ...
  // Wires for unoc and shim connections
    ...
    logic [8:0]  shim_ch7_unoc_wr_addr_to_unoc_backbone;
        ...
        (* altera_attribute = {"-name FORCE_HYPER_REGISTER_FOR_PERIPHERY_CORE_TRANSFER ON; -name FORCE_HYPER_REGISTER_FOR_CORE_PERIPHERY_TRANSFER ON; -name NOC_INITIATOR ON; -name NOC_ISOLATION_GROUP DEFAULT"} *) tennm_noc_initiator # (
