	component platform_intel_pcie_rtile_mcdma_0 is
		port (
			app_clk                      : out std_logic;                                         -- clk
			app_rst_n                    : out std_logic;                                         -- reset_n
			rx_pio_waitrequest_i         : in  std_logic                      := 'X';             -- waitrequest
			rx_pio_address_o             : out std_logic_vector(24 downto 0);                     -- address
			...
			p0_app_slow_reset_status_n   : out std_logic;                                         -- reset_n
			...
			app_slow_clk                 : out std_logic;                                         -- clk
			...
			p1_app_slow_reset_status_n   : out std_logic;                                         -- reset_n
			...
			p1_bam_waitrequest_i         : in  std_logic                      := 'X';             -- waitrequest
			p1_bam_address_o             : out std_logic_vector(21 downto 0);                     -- address
			p1_bam_byteenable_o          : out std_logic_vector(63 downto 0);                     -- byteenable
			p1_bam_read_o                : out std_logic;                                         -- read
			p1_bam_readdata_i            : in  std_logic_vector(511 downto 0) := (others => 'X'); -- readdata
			p1_bam_readdatavalid_i       : in  std_logic                      := 'X';             -- readdatavalid
			p1_bam_write_o               : out std_logic;                                         -- write
			p1_bam_writedata_o           : out std_logic_vector(511 downto 0);                    -- writedata
			p1_bam_burstcount_o          : out std_logic_vector(3 downto 0)                       -- burstcount
		);
	end component platform_intel_pcie_rtile_mcdma_0;

	u0 : component platform_intel_pcie_rtile_mcdma_0
		port map (
			...
			p0_app_slow_reset_status_n   => CONNECTED_TO_p0_app_slow_reset_status_n,   -- p0_slow_reset_status_n.reset_n
			...
			app_slow_clk                 => CONNECTED_TO_app_slow_clk,                 --           app_slow_clk.clk
			...
			p1_app_slow_reset_status_n   => CONNECTED_TO_p1_app_slow_reset_status_n,   -- p1_slow_reset_status_n.reset_n
			p1_link_up_o                 => CONNECTED_TO_p1_link_up_o,                 --          p1_hip_status.link_up
			p1_dl_up_o                   => CONNECTED_TO_p1_dl_up_o,                   --                       .dl_up
			p1_surprise_down_err_o       => CONNECTED_TO_p1_surprise_down_err_o,       --                       .surprise_down_err
			p1_dl_timer_update_o         => CONNECTED_TO_p1_dl_timer_update_o,         --                       .dl_timer_update
			p1_ltssm_state_delay_o       => CONNECTED_TO_p1_ltssm_state_delay_o,       --                       .ltssm_state_delay
			p1_ltssm_st_hipfifo_ovrflw_o => CONNECTED_TO_p1_ltssm_st_hipfifo_ovrflw_o, --                       .ltssm_st_hipfifo_ovrflw
			p1_app_xfer_pending_i        => CONNECTED_TO_p1_app_xfer_pending_i,        --          p1_power_mgnt.app_xfer_pending
			p1_bam_waitrequest_i         => CONNECTED_TO_p1_bam_waitrequest_i,         --          p1_bam_master.waitrequest
			p1_bam_address_o             => CONNECTED_TO_p1_bam_address_o,             --                       .address
			p1_bam_byteenable_o          => CONNECTED_TO_p1_bam_byteenable_o,          --                       .byteenable
			p1_bam_read_o                => CONNECTED_TO_p1_bam_read_o,                --                       .read
			p1_bam_readdata_i            => CONNECTED_TO_p1_bam_readdata_i,            --                       .readdata
			p1_bam_readdatavalid_i       => CONNECTED_TO_p1_bam_readdatavalid_i,       --                       .readdatavalid
			p1_bam_write_o               => CONNECTED_TO_p1_bam_write_o,               --                       .write
			p1_bam_writedata_o           => CONNECTED_TO_p1_bam_writedata_o,           --                       .writedata
			p1_bam_burstcount_o          => CONNECTED_TO_p1_bam_burstcount_o           --                       .burstcount
		);
