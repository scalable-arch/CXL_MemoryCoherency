module platform_intel_pcie_rtile_mcdma_0 (
		...
		output wire [24:0]  rx_pio_address_o,             //                       .address,                 Check User Guide for details
		...
		output wire         p0_app_slow_reset_status_n,   // p0_slow_reset_status_n.reset_n,                 Check User Guide for details
		...
		output wire         app_slow_clk,                 //           app_slow_clk.clk,                     Check User Guide for details
		...
		output wire         p1_app_slow_reset_status_n,   // p1_slow_reset_status_n.reset_n,                 Check User Guide for details
		output wire         p1_link_up_o,                 //          p1_hip_status.link_up,                 Check User Guide for details
		output wire         p1_dl_up_o,                   //                       .dl_up,                   Check User Guide for details
		output wire         p1_surprise_down_err_o,       //                       .surprise_down_err,       Check User Guide for details
		output wire         p1_dl_timer_update_o,         //                       .dl_timer_update,         Check User Guide for details
		output wire [5:0]   p1_ltssm_state_delay_o,       //                       .ltssm_state_delay,       Check User Guide for details
		output wire         p1_ltssm_st_hipfifo_ovrflw_o, //                       .ltssm_st_hipfifo_ovrflw, Check User Guide for details
		input  wire         p1_app_xfer_pending_i,        //          p1_power_mgnt.app_xfer_pending,        Check User Guide for details
		input  wire         p1_bam_waitrequest_i,         //          p1_bam_master.waitrequest,             Check User Guide for details
		output wire [21:0]  p1_bam_address_o,             //                       .address,                 Check User Guide for details
		output wire [63:0]  p1_bam_byteenable_o,          //                       .byteenable,              Check User Guide for details
		output wire         p1_bam_read_o,                //                       .read,                    Check User Guide for details
		input  wire [511:0] p1_bam_readdata_i,            //                       .readdata,                Check User Guide for details
		input  wire         p1_bam_readdatavalid_i,       //                       .readdatavalid,           Check User Guide for details
		output wire         p1_bam_write_o,               //                       .write,                   Check User Guide for details
		output wire [511:0] p1_bam_writedata_o,           //                       .writedata,               Check User Guide for details
		output wire [3:0]   p1_bam_burstcount_o           //                       .burstcount,              Check User Guide for details
	);
endmodule
