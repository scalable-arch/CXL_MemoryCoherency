	component platform_address_span_extender_2 is
		generic (
		...
		port (
			...
			avm_m0_address       : out std_logic_vector(43 downto 0);                     -- address
	...
	end component platform_address_span_extender_2;

	u0 : component platform_address_span_extender_2
		generic map (
