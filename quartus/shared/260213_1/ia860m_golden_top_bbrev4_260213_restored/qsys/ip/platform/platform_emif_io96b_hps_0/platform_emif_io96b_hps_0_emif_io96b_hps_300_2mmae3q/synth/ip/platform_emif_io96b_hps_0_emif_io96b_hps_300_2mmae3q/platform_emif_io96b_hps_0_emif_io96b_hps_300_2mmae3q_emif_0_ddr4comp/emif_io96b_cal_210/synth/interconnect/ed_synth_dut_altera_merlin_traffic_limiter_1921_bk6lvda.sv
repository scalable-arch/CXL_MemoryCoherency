...
module ed_synth_dut_altera_merlin_traffic_limiter_1921_bk6lvda
#(
   parameter
      PKT_TRANS_POSTED           = 1,
      PKT_DEST_ID_H              = 0,
  ...
  endgenerate
     ...
     if (REORDER) begin: fifo_dest_id_write_read_control_reorder_on
       ...
       if (ENABLE_OOO == 0 | USE_FIFO == 0) begin : REORDER_WITHOUT_FIFO_OR_INORDER_RSP
           ...
           always_ff @(posedge clk, posedge reset) begin
                 if (reset) begin
                    ...
                    if (rsp_src_ready && reorder_mem_valid) begin
                       if (reorder_mem_endofpacket == 1) begin 
         ...
         if (ENABLE_OOO == 0) begin : REORDER_for_in_order_rsp
           ...
           ed_synth_dut_altera_merlin_traffic_limiter_altera_avalon_sc_fifo_1921_7ekoqry #(
                 .SYMBOLS_PER_BEAT   (1),
         ...
         always_comb begin
           if (rsp_src_ready_p1 && reorder_mem_valid_p0 && reorder_mem_out_data_p0[1]) begin     
             hold_pointer = 1'b1;
           end
           else if (rsp_src_ready && reorder_mem_valid_p1 && reorder_mem_out_data_p1[0] )  begin   
             hold_pointer = 1'b0;
           end
         end
   ...
   assign trans_sequence = '0;
       ...
       always_comb begin
          ...
          rsp_sink_ready       = reorder_mem_ready; 
   ...
   generate
      if (REORDER) begin : prevent_hazard_block
         ...
         assign suppress_change_trans_but_not_dest = 1'b0; 
      end
   endgenerate
   ...
   generate
      if (REORDER) begin : prevent_hazard_block_for_particular_slave
         ...
         assign suppress_change_trans_for_one_slave = 1'b0; 
      end
   endgenerate
...
`pragma questa_oem_00 ""
`endif