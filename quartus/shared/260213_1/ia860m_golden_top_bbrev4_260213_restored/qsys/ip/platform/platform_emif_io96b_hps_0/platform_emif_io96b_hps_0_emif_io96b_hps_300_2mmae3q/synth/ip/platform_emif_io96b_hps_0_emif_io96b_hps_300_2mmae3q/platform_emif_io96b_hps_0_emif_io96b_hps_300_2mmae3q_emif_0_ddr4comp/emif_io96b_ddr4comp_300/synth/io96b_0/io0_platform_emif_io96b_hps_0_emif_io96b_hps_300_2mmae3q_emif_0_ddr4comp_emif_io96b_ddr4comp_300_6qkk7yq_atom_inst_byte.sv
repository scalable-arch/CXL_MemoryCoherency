...
module io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_byte #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_byte::*;
   ...
   assign { i_phy_tx_wrdata_en0,
            ...
            i_rxfifo_skew,
            i_rxfifo_spare,
            i_phy_parkclk_to_rxtop_n0_pl1,
            i_phy_parkclk_to_rxtop_n1_pl1
            } = bc_to_b;
...
`define byte_pinX_params(X)                                                                  \
            ...
            .pin``X``_rx_rzq_cycle                (PIN_RX_RZQ_CYCLE          [ID*12+``X``]), \
            ...
            .pin``X``_tx_rzq_cycle                (PIN_TX_RZQ_CYCLE          [ID*12+``X``]), \
