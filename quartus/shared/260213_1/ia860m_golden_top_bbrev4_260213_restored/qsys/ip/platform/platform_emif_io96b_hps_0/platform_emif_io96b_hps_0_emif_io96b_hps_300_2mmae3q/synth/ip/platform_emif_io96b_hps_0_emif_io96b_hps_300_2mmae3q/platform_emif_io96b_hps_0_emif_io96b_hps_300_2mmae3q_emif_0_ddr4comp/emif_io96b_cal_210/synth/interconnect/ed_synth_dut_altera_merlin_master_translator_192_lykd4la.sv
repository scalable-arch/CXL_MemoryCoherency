...
module ed_synth_dut_altera_merlin_master_translator_192_lykd4la #(
   parameter
      AV_ADDRESS_W                = 32,
      AV_DATA_W                   = 32,
      AV_BURSTCOUNT_W             = 4,
   ...
   always_comb begin
      uav_burstcount_pre = symbols_per_word;  
   ...
   if (SYNC_RESET == 0) begin : async_rst1
      always @(posedge clk, posedge reset) begin
         if (reset)
            ...
            else if (read_accepted == 1 && uav_readdatavalid == 1)  
               read_accepted <= 1'b0;
         end
      end
   end
         ...
         always @(posedge clk or posedge reset) begin
            if (reset) begin
               ...
               if (
                  ...
                  (av_write_r | av_read_r) &&         
                  (!USE_CHIPSELECT | av_chipselect_r) 
               ) begin
...
`pragma questa_oem_00 ""
`endif