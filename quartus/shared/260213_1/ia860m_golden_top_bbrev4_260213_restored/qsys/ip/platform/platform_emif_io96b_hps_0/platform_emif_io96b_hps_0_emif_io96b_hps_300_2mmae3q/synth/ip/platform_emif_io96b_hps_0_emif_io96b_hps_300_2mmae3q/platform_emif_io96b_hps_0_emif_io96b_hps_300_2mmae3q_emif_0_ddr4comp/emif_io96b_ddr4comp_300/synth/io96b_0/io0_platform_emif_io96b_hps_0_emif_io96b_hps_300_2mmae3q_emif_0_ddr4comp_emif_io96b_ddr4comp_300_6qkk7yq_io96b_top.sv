...
module io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_io96b_top #(
   ...
   localparam PORT_AXI_FBR_USER_WIDTH  = 64,
   localparam PORT_AXI_NOC_USER_WIDTH  = 32,
   localparam PORT_AXI_INTF_USER_WIDTH   = PHY_NOC_EN ? PORT_AXI_NOC_USER_WIDTH : PORT_AXI_FBR_USER_WIDTH,
   ...
   localparam PORT_MEM_RESET_N_WIDTH = (MEM_RESET_N_WIDTH == 0) ? 1 : MEM_RESET_N_WIDTH, 
   localparam PORT_MEM_CK_T_WIDTH    = (MEM_CK_T_WIDTH == 0)    ? 1 : MEM_CK_T_WIDTH,
   localparam PORT_MEM_CK_C_WIDTH    = (MEM_CK_C_WIDTH == 0)    ? 1 : MEM_CK_C_WIDTH
   ...
   input  logic    [PORT_AXI_INTF_USER_WIDTH-1:0]              s0_axi4_wuser,
   ...
   output logic    [PORT_AXI_INTF_USER_WIDTH-1:0]              s0_axi4_ruser,
   ...
   input  logic    [PORT_AXI_INTF_USER_WIDTH-1:0]              s1_axi4_wuser,
   ...
   output logic    [PORT_AXI_INTF_USER_WIDTH-1:0]              s1_axi4_ruser,
   ...
   output      logic [PORT_MEM_CK_T_WIDTH-1:0]                   mem_ck_t_0,
   output      logic [PORT_MEM_CK_C_WIDTH-1:0]                   mem_ck_c_0,
   ...
   output      logic [PORT_MEM_RESET_N_WIDTH-1:0]           mem_reset_n_0,
   ...
   output      logic [PORT_MEM_CK_T_WIDTH-1:0]                   mem_ck_t_1,
   output      logic [PORT_MEM_CK_C_WIDTH-1:0]                   mem_ck_c_1,
   ...
   localparam INTF_BC_TO_B_WIDTH = 587 ;
   ...
   localparam INTF_PA_TO_SEQ_WIDTH  = PORT_SEQ_CFG_DATA_WIDTH +
    ...
    localparam [1:0] MC_USED = { io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_hmc_slim::IS_USED == 1 && io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_hmc_slim::IS_DUMMY_SLIM == 0,
                                 io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_hmc_wide::IS_USED == 1};
    
    localparam LOCKSTEP_SECONDARY =  io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_hmc_wide::LOCKSTEP_CONFIG == "LOCKSTEP_CONFIG_SECONDARY";
   ...
   AXI_BUS #( 
      ...
      .PORT_AXI_USER_WIDTH    (PORT_AXI_INTF_USER_WIDTH),
   ...
   generate
      if (PHY_NOC_EN) begin : noc_en
         ...
         for (genvar i0 = 0; i0 < 2; ++i0) begin : intf
            ...
            assign core_fanoc_axi_intf[i0].awprot     = '0;
            assign core_fanoc_axi_intf[i0].arcache    = '0;
            assign core_fanoc_axi_intf[i0].arprot     = '0;

            assign fbr_axi_adapter_intf[i0].araddr    = '0;
            assign fbr_axi_adapter_intf[i0].arburst   = '0;
            assign fbr_axi_adapter_intf[i0].arid      = '0;
            assign fbr_axi_adapter_intf[i0].arlen     = '0;
            assign fbr_axi_adapter_intf[i0].arlock    = '0;
            assign fbr_axi_adapter_intf[i0].arqos     = '0;
            assign fbr_axi_adapter_intf[i0].arsize    = '0;
            assign fbr_axi_adapter_intf[i0].arcache   = '0;
            assign fbr_axi_adapter_intf[i0].arprot    = '0;
            assign fbr_axi_adapter_intf[i0].aruser    = '0;
            assign fbr_axi_adapter_intf[i0].arvalid   = '0;
            assign fbr_axi_adapter_intf[i0].awaddr    = '0;
            assign fbr_axi_adapter_intf[i0].awburst   = '0;
            assign fbr_axi_adapter_intf[i0].awcache   = '0;
            assign fbr_axi_adapter_intf[i0].awprot    = '0;
            assign fbr_axi_adapter_intf[i0].awid      = '0;
            assign fbr_axi_adapter_intf[i0].awlen     = '0;
            assign fbr_axi_adapter_intf[i0].awlock    = '0;
            assign fbr_axi_adapter_intf[i0].awqos     = '0;
            assign fbr_axi_adapter_intf[i0].awsize    = '0;
            assign fbr_axi_adapter_intf[i0].awuser    = '0;
            assign fbr_axi_adapter_intf[i0].awvalid   = '0;
            assign fbr_axi_adapter_intf[i0].bready    = '0;
            assign fbr_axi_adapter_intf[i0].rready    = '0;
            assign fbr_axi_adapter_intf[i0].wdata     = '0;
            assign fbr_axi_adapter_intf[i0].wlast     = '0;
            assign fbr_axi_adapter_intf[i0].wstrb     = '0;
            assign fbr_axi_adapter_intf[i0].wuser     = '0;
         ...
         for (genvar i1 = 0; i1 < 2; ++i1) begin : intf
            ...
            assign fbr_axi_adapter_intf[i1].wuser   = '0;
            assign fbr_axi_adapter_intf[i1].awprot  = '0;
            assign fbr_axi_adapter_intf[i1].arcache = '0;
            assign fbr_axi_adapter_intf[i1].arprot  = '0;

            assign core_fanoc_axi_intf[i1].araddr    = '0;
            assign core_fanoc_axi_intf[i1].arburst   = '0;
            assign core_fanoc_axi_intf[i1].arid      = '0;
            assign core_fanoc_axi_intf[i1].arlen     = '0;
            assign core_fanoc_axi_intf[i1].arlock    = '0;
            assign core_fanoc_axi_intf[i1].arqos     = '0;
            assign core_fanoc_axi_intf[i1].arsize    = '0;
            assign core_fanoc_axi_intf[i1].arcache   = '0;
            assign core_fanoc_axi_intf[i1].arprot    = '0;
            assign core_fanoc_axi_intf[i1].aruser    = '0;
            assign core_fanoc_axi_intf[i1].arvalid   = '0;
            assign core_fanoc_axi_intf[i1].awaddr    = '0;
            assign core_fanoc_axi_intf[i1].awburst   = '0;
            assign core_fanoc_axi_intf[i1].awcache   = '0;
            assign core_fanoc_axi_intf[i1].awprot    = '0;
            assign core_fanoc_axi_intf[i1].awid      = '0;
            assign core_fanoc_axi_intf[i1].awlen     = '0;
            assign core_fanoc_axi_intf[i1].awlock    = '0;
            assign core_fanoc_axi_intf[i1].awqos     = '0;
            assign core_fanoc_axi_intf[i1].awsize    = '0;
            assign core_fanoc_axi_intf[i1].awuser    = '0;
            assign core_fanoc_axi_intf[i1].awvalid   = '0;
            assign core_fanoc_axi_intf[i1].bready    = '0;
            assign core_fanoc_axi_intf[i1].rready    = '0;
            assign core_fanoc_axi_intf[i1].wdata     = '0;
            assign core_fanoc_axi_intf[i1].wlast     = '0;
            assign core_fanoc_axi_intf[i1].wstrb     = '0;
            assign core_fanoc_axi_intf[i1].wuser     = '0;
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_bufs_mem # (
   ...
   generate
      if (PHY_I3C_EN) begin : i3c
         io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_bufs_i3c # (
   ...
   generate
      ...
      for (i = 0; i < NUM_BYTES_IN_IO96; ++i) begin: gen_byte_conns
         ...
         io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_byte # (
            .ID(i)
         ) wrapper_byte (
         ...
         io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_byte_ctrl # (
            .ID(i)
         ) wrapper_byte_ctrl (
        ...
        io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_pa # (
            .ID(i)
        ) wrapper_pa (
            .hmc_to_pa (mc_to_pa), 
            .pa_to_hmc (pa_to_mc), 
        ...
        io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_fa_lane # (
            .ID(i)
         ) wrapper_falane (
         ...
         if (io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_byte_ctrl::IS_USED[i] && io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_byte::IS_USED[i]) begin
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_hmc_wide # (
      .ID(0),
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_hmc_slim # (
      .ID(1),
      .AXI4_ADDR_WIDTH(AXI4_ADDR_WIDTH),
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_fa_hmc # (
      .ID(0)
   ) wrapper_fahmc_wide (
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_fa_noc # (
      .ID(0)
   ) wrapper_fanoc_wide (
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_pll # (
   ) wrapper_pll (
      .ref_clk    (ref_clk_0),
      .rst_n      (pll_rst_n),
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_cpa # (
   ) wrapper_cpa (
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_fbr_axi_adapter_wide # (
      .PORT_AXI_AXADDR_WIDTH     (PORT_AXI_AXADDR_WIDTH    ),
      .PORT_AXI_AXBURST_WIDTH    (PORT_AXI_AXBURST_WIDTH   ),
      .PORT_AXI_AXID_WIDTH       (PORT_AXI_AXID_WIDTH      ),
      .PORT_AXI_AXLEN_WIDTH      (PORT_AXI_AXLEN_WIDTH     ),
      ...
      .PORT_AXI_DATA_WIDTH       (PORT_AXI_DATA_WIDTH      ),
      .PORT_AXI_STRB_WIDTH       (PORT_AXI_STRB_WIDTH      ),
      .PORT_AXI_USER_WIDTH       (PORT_AXI_FBR_USER_WIDTH  ),
      .PORT_AXI_ID_WIDTH         (PORT_AXI_ID_WIDTH        ),
      .PORT_AXI_RESP_WIDTH       (PORT_AXI_RESP_WIDTH      ),
   ...
   io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_fbr_axi_adapter_slim # (
      .PORT_AXI_AXADDR_WIDTH     (PORT_AXI_AXADDR_WIDTH    ),
      .PORT_AXI_AXBURST_WIDTH    (PORT_AXI_AXBURST_WIDTH   ),
      .PORT_AXI_AXID_WIDTH       (PORT_AXI_AXID_WIDTH      ),
      .PORT_AXI_AXLEN_WIDTH      (PORT_AXI_AXLEN_WIDTH     ),
      ...
      .INTF_CORE_TO_FALANE_WIDTH (INTF_CORE_TO_FALANE_WIDTH),
      .INTF_FALANE_TO_CORE_WIDTH (INTF_FALANE_TO_CORE_WIDTH),
      .FULL_TRANS_SIZE           ((MEM_NUM_CHANNELS_PER_IO96 == 1 && MC_USED == 2'b11) ? 4 : 5)
