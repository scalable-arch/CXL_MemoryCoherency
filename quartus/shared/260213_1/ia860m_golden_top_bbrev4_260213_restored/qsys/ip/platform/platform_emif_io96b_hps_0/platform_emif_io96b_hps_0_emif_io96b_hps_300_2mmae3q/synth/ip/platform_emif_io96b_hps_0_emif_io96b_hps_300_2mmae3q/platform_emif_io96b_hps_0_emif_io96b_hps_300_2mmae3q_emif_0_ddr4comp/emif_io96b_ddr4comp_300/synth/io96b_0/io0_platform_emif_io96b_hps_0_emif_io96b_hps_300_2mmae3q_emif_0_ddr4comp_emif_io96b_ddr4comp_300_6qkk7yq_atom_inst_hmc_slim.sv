...
module io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_phy_arch_fp_atom_inst_hmc_slim #(
   ...
   timeunit 1ns;
   timeprecision 1ps;
   import io0_platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_emif_io96b_ddr4comp_300_6qkk7yq_atom_attr_hmc_slim::*;
   ...
   generate
      ...
      end else if (IS_USED) begin : gen_tennm_slim 
         tennm_hmc # (
            .base_address                                         (BASE_ADDRESS),
            .ctlr_axi_bus_config                                  (CTLR_AXI_BUS_CONFIG),
            .ctlr_bist_config                                     (CTLR_BIST_CONFIG),
