...
module platform_emif_io96b_hps_0_emif_io96b_hps_300_2mmae3q_emif_0_ddr4comp_intel_noc_target_210_dahi33y # (
 ...
 if (CHOOSE_AXI=="AXI4") begin : target_0
    ...
    (* altera_attribute = {"-name PRESERVE_FANOUT_FREE_WYSIWYG ON; -name NOC_TARGET ON; -name NOC_TARGET_ADDRESS_RANGE 27; -name AXI_LITE_NOC_BRIDGE ON; -name NOC_ISOLATION_GROUP DEFAULT; -name NOC_NON_USER_NIU ON"} *) tennm_noc_axilite_target # (
    .NOC_TARGET_ECC_EN (NOC_TARGET_ECC_EN),
    .NOC_SECURE_FILTER_ENA (NOC_SECURE_FILTER_ENA),
    .NOC_TARGET_DFD_EN(NOC_TARGET_DFD_EN),
