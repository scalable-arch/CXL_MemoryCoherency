...
# PRUNED_UNUSED_CLOCK create_clock -name {USER_CLK1}            -period  10.000 [get_ports USER_CLK1] 
# 1PPS (pulse per second). Tested with a 10MHz external source
# PRUNED_UNUSED_CLOCK create_clock -name {U1PPS}                -period 100.000 [get_ports U1PPS]
# ClkA/External Clock. Tested with a 10MHz external source
# PRUNED_UNUSED_CLOCK create_clock -name {CLKA}                 -period 100.000 [get_ports CLKA]
...
# PRUNED_UNUSED_CLOCK create_clock -name {QSFP0_REFCLK}         -period   6.400 [get_ports QSFP0_REFCLK]
# F-Tile Ref Clock Channel 2 100MHz - Refclk #2
# PRUNED_UNUSED_CLOCK create_clock -name {MCIO_REFCLK}          -period  11.000 [get_ports MCIO_REFCLK]
# F-Tile Ref Clock Channel 5 156.25MHz - Refclk #5
# PRUNED_UNUSED_CLOCK create_clock -name {QSFP1_REFCLK}         -period   6.400 [get_ports QSFP1_REFCLK]
# F-Tile Ref Clock Channel 2 100MHz - Refclk #2
# PRUNED_UNUSED_CLOCK create_clock -name {M2_REFCLK}            -period  10.000 [get_ports M2_REFCLK]
# F-Tile Ref Clock Channel 5 156.25MHz - Refclk #5
# PRUNED_UNUSED_CLOCK create_clock -name {QSFP2_REFCLK}         -period   6.400 [get_ports QSFP2_REFCLK]
# LVDS Clock (Single-Ended at FPGA).  Tested with a 125MHz external source
# PRUNED_UNUSED_CLOCK create_clock -name {EXT_SE_CLK}           -period   8.000 [get_ports EXT_SE_CLK]
...
# PRUNED_UNUSED_CLOCK create_clock -name {HBM_REFCLK1}          -period  10.000 [get_ports HBM_REFCLK1]
...
# PRUNED_UNUSED_CLOCK create_clock -name {HBM_FBR_REFCLK1}      -period  10.000 [get_ports HBM_FBR_REFCLK1]
...
# PRUNED_UNUSED_CLOCK create_clock -name {FPGA_IG_SPI_SCK}      -period  40.000 [get_ports FPGA_IG_SPI_SCK]
