...
set_location_assignment PIN_W58 -to USER_CLK1
set_location_assignment PIN_Y59 -to "USER_CLK1(n)"
set_instance_assignment -name IO_STANDARD "1.2V TRUE DIFFERENTIAL SIGNALING" -to USER_CLK1
set_instance_assignment -name INPUT_TERMINATION DIFFERENTIAL -to USER_CLK1
...
set_location_assignment PIN_FL52 -to MCIO_CWAKEA
set_location_assignment PIN_FM51 -to MCIO_BP_TYPEA
set_location_assignment PIN_FR52 -to MCIO_CPRSNTA
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_CWAKEA
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_BP_TYPEA
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_CPRSNTA

set_location_assignment PIN_FU58 -to MCIO_CWAKEB
set_location_assignment PIN_FV57 -to MCIO_BP_TYPEB
set_location_assignment PIN_GA58 -to MCIO_CPRSNTB
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_CWAKEB
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_BP_TYPEB
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_CPRSNTB

set_location_assignment PIN_FC56 -to MCIO_I2C0_SCL
set_location_assignment PIN_FB55 -to MCIO_I2C0_SDA
set_location_assignment PIN_FV55 -to MCIO_I2C1_SCL
set_location_assignment PIN_FU56 -to MCIO_I2C1_SDA
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_I2C0_SCL
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_I2C0_SDA
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_I2C1_SCL
set_instance_assignment -name IO_STANDARD "1.2 V" -to MCIO_I2C1_SDA
set_instance_assignment -name WEAK_PULL_UP_RESISTOR OFF -to MCIO_I2C0_SCL
set_instance_assignment -name WEAK_PULL_UP_RESISTOR OFF -to MCIO_I2C0_SDA
set_instance_assignment -name WEAK_PULL_UP_RESISTOR OFF -to MCIO_I2C1_SCL
set_instance_assignment -name WEAK_PULL_UP_RESISTOR OFF -to MCIO_I2C1_SDA
set_instance_assignment -name AUTO_OPEN_DRAIN_PINS ON -to MCIO_I2C0_SCL
set_instance_assignment -name AUTO_OPEN_DRAIN_PINS ON -to MCIO_I2C0_SDA
set_instance_assignment -name AUTO_OPEN_DRAIN_PINS ON -to MCIO_I2C1_SCL
set_instance_assignment -name AUTO_OPEN_DRAIN_PINS ON -to MCIO_I2C1_SDA
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to MCIO_I2C0_SCL
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to MCIO_I2C0_SDA
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to MCIO_I2C1_SCL
set_instance_assignment -name FAST_OUTPUT_REGISTER ON -to MCIO_I2C1_SDA
...
set_instance_assignment -name IO_STANDARD "1.2 V" -to FPGA_LED_G_L
set_instance_assignment -name IO_STANDARD "1.2 V" -to FPGA_LED_R_L
...
set_instance_assignment -name IO_STANDARD "1.2 V" -to EXT_GPIO_IN[0]
set_instance_assignment -name IO_STANDARD "1.2 V" -to EXT_GPIO_IN[1]
# Output Only (from FPGA)
set_location_assignment PIN_FL54 -to EXT_GPIO_OUT
set_instance_assignment -name IO_STANDARD "1.2 V" -to EXT_GPIO_OUT
...
set_instance_assignment -name IO_STANDARD 1.8V -to EXT_M2_GPIO_EN_L
set_instance_assignment -name IO_STANDARD 1.8V -to EXT_MCIO_GPIO_EN_L
set_instance_assignment -name IO_STANDARD 1.8V -to HPS_CLK
set_instance_assignment -name IO_STANDARD 1.8V -to M2_SMB_DAT
set_instance_assignment -name IO_STANDARD 1.8V -to M2_SMB_CLK

# HPS_IOB_1  - PIN_H7
set_location_assignment PIN_H7 -to M2_PEWAKE_L
# HPS_IOB_2  - PIN_L4
set_location_assignment PIN_L4 -to M2_CLKREQ_L
# HPS_IOB_3  - PIN_H9
set_location_assignment PIN_H9 -to HPS_UART_TXD
# HPS_IOB_4  - PIN_K3
set_location_assignment PIN_K3 -to HPS_UART_RXD
# HPS_IOB_5  - PIN_G6
set_location_assignment PIN_G6 -to M2_PERST_OUT_L
# HPS_IOB_6  - PIN_H3
set_location_assignment PIN_H3  -to MCIO_PERST_OUT_L
# HPS_IOB_7  - PIN_N12
...
set_instance_assignment -name IO_STANDARD 1.8V -to M2_PEWAKE_L
set_instance_assignment -name IO_STANDARD 1.8V -to M2_CLKREQ_L
...
set_instance_assignment -name IO_STANDARD 1.8V -to M2_PERST_OUT_L
set_instance_assignment -name IO_STANDARD 1.8V -to MCIO_PERST_OUT_L
set_instance_assignment -name IO_STANDARD 1.8V -to ETH_PHY_RESET_L
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_MDIO
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_MDC
set_instance_assignment -name IO_STANDARD 1.8V -to MCIO_PERSTA
set_instance_assignment -name IO_STANDARD 1.8V -to MCIO_PERSTB
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_TX_CLK
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_TX_CTL
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_RX_CLK
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_RX_CTL
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_TXD
set_instance_assignment -name IO_STANDARD 1.8V -to EMAC_RXD
